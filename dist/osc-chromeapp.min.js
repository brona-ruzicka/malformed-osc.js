...
var osc = osc || {}, osc = (!function() {
    ...
    1) ? new util.TextEncoder("utf-8") : void 0, osc.dataView = function(e, t, r) {
        ...
        t = Object.assign({}, osc.defaults, t);
        ...
        if (0 === e.indexOf("/") || r.ignoreMissingAdressSlash) return {
            address: e,
            args: 1 === (t = osc.readArguments(t, r, n)).length && r.unpackSingleArgs ? t[0] : t
        };
        throw new Error("A malformed OSC address was found while reading an OSC message. String was: " + e);
        ...
        if (t = Object.assign({}, osc.defaults, t), osc.isValidMessage(e)) return t = osc.collectMessageParts(e, t), 
        osc.joinParts(t);
        ...
        if ("/" === s || t.ignoreMissingAdressSlash) return osc.readMessageContents(i, e, t, r);
    ...
    return r = [ function(e, t) {
        ...
        r(-1)), E = (n.NEG_ONE = S, g(-1, 2147483647, !1)), A = (n.MAX_VALUE = E, 
        g(-1, -1, !0)), P = (n.MAX_UNSIGNED_VALUE = A, g(0, -2147483648, !1)), T = (n.MIN_VALUE = P, 
        n.prototype);
        T.toInt = function() {
            ...
            var t, r;
            if (this.isNegative()) return this.eq(P) ? (r = l(e), r = (t = this.div(r)).mul(r).sub(this), 
            ...
            return this.isZero() ? y : (d(e) || (e = p(e)), m ? g(m.mul(this.low, this.high, e.low, e.high), m.get_high(), this.unsigned) : e.isZero() ? y : this.eq(P) ? e.isOdd() ? P : y : e.eq(P) ? this.isOdd() ? P : y : this.isNegative() ? e.isNegative() ? this.neg().mul(e.neg()) : this.neg().mul(e).neg() : e.isNegative() ? this.mul(e.neg()).neg() : this.lt(w) && e.lt(w) ? l(this.toNumber() * e.toNumber(), this.unsigned) : (t = this.high >>> 16, 
            ...
            if (this.unsigned) {
                ...
                if (this.eq(P)) return e.eq(v) || e.eq(S) ? P : e.eq(P) ? v : (n = this.shr(1).div(e).shl(1)).eq(y) ? e.isNegative() ? v : S : (t = this.sub(e.mul(n)), 
                n.add(t.div(e)));
                if (e.eq(P)) return this.unsigned ? f : y;
    ...
    osc.supportsSerial = !1, osc.firePacketEvents = function(e, t, r, n) {
        ...
        this.options = Object.assign({}, osc.defaults, e), this.on("data", this.decodeOSC.bind(this));
    };
    ...
    e.constructor = osc.Port, e.send = function(e) {
        ...
        var t = this, e = this.options = Object.assign({}, {
            useSLIP: !0
        }, osc.defaults, e), e = (this.decoder = new slip.Decoder({
    ...
    e.encodeOSC = function(e) {
        ...
        (this.options = Object.assign({}, osc.defaults, r)).raw = !1, this.port1 = e, 
        this.port2 = t, this.listen();
