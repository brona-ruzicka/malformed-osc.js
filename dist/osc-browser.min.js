...
var osc = osc || {}, osc = (!function() {
    ...
    return r = [ function(e, t) {
        ...
        r(-1)), E = (n.NEG_ONE = S, l(-1, 2147483647, !1)), A = (n.MAX_VALUE = E, 
        ...
        P.toInt = function() {
            ...
            if (this.unsigned) {
                ...
                if (this.eq(B)) return e.eq(v) || e.eq(S) ? B : e.eq(B) ? v : (n = this.shr(1).div(e).shl(1)).eq(m) ? e.isNegative() ? v : S : (t = this.sub(e.mul(n)), 
                n.add(t.div(e)));
