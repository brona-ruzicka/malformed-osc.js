    ...
    var c = c || {}, c = (!function() {
        ...
        1) ? new util.TextEncoder("utf-8") : void 0, c.dataView = function(e, t, r) {
            ...
            if (0 === e.indexOf("/") || r.ignoreMissingAdressSlash) return {
                address: e,
                args: 1 === (t = c.readArguments(t, r, n)).length && r.unpackSingleArgs ? t[0] : t
            };
            ...
            if (t = Object.assign({}, c.defaults, t), c.isValidMessage(e)) return t = c.collectMessageParts(e, t), 
            c.joinParts(t);
            ...
            if ("/" === o || t.ignoreMissingAdressSlash) return c.readMessageContents(i, e, t, r);
        ...
        c.supportsSerial = !1, c.firePacketEvents = function(e, t, r, n) {
            ...
            this.options = Object.assign({}, c.defaults, e), this.on("data", this.decodeOSC.bind(this));
        };
        ...
        e.constructor = c.Port, e.send = function(e) {
            ...
            var t = this, e = this.options = Object.assign({}, {
                useSLIP: !0
            }, c.defaults, e), e = (this.decoder = new n.Decoder({
        ...
        e.encodeOSC = function(e) {
            ...
            (this.options = Object.assign({}, c.defaults, r)).raw = !1, this.port1 = e, 
