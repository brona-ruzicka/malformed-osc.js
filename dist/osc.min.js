...
!function() {
    ...
    1) ? new util.TextEncoder("utf-8") : void 0, osc.dataView = function(e, r, t) {
        ...
        if (osc.isTypedArrayView(e) && osc.isTypedArrayView(r)) r.set(e, t); else for (var n = void 0 === t ? 0 : t, o = Math.min(r.length - t, e.length), i = 0, s = n; i < o; i++, 
        s++) r[s] = e[i];
        return r;
        ...
        (t ? r : n).length), i = new Uint8Array(o + 3 & -4), s = 0; s < o - 1; s++) {
            var a = t ? r[s] : n.charCodeAt(s);
            i[s] = a;
        }
        return i;
        ...
        for (var s = 0; s < r.length; ) {
            ...
            if ("[" === a) {
                ...
                s += u + 2;
            } else c = osc.readArgument(a, t, n, o, i), s++;
            e.push(c);
        }
        return e;
        ...
        return t.byteLength += s.byteLength, t.parts.splice(r, 0, s), t;
    }, osc.readMessage = function(e, r, t) {
        r = Object.assign({}, osc.defaults, r);
        ...
        if (0 === e.indexOf("/") || t.ignoreMissingAdressSlash) return {
            address: e,
            args: 1 === (r = osc.readArguments(r, t, n)).length && t.unpackSingleArgs ? r[0] : r
        };
        ...
        if (r = Object.assign({}, osc.defaults, r), osc.isValidMessage(e)) return r = osc.collectMessageParts(e, r), 
        osc.joinParts(r);
        ...
        for (var o = osc.readTimeTag(e, t), i = []; t.idx < n; ) {
            var s = osc.readInt32(e, t), s = t.idx + s, s = osc.readPacket(e, r, t, s);
            i.push(s);
        }
        return {
            timeTag: o,
        ...
        if ("/" === i || r.ignoreMissingAdressSlash) return osc.readMessageContents(o, e, r, t);
